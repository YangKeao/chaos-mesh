...
func (d *ContainerRecordDecoder) DecodeContainerRecord(ctx context.Context, record *v1alpha2.Record, obj v1alpha2.InnerObject) (decoded DecodedContainerRecord, err error) {
	var pod v1.Pod
